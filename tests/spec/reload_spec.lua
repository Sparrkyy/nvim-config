...
describe("reload", function()
  ...
  it("re-registers the flow commands, so :FlowPlan survives a reload", function()
    ...
    assert.is_truthy(vim.api.nvim_get_commands({})["FlowReview"])
    assert.is_truthy(vim.api.nvim_get_commands({})["FlowPlanReview"])
    assert.is_truthy(vim.api.nvim_get_commands({})["FlowFeedback"])
    assert.is_truthy(vim.api.nvim_get_commands({})["FlowComment"])
    assert.is_truthy(vim.api.nvim_get_commands({})["FlowSubmit"])
    assert.is_truthy(vim.api.nvim_get_commands({})["FlowApprove"])
